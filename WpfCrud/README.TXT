...
5. Common
- Reuseable application functionality


ASSUMPTIONS MADE
----------------------------------------------------------
Application maybe used in different timezones, therefore timezone offsets are important and should be visible to the user
15,30,45,60 second durations were recommendations, not constraints, so I didn't enforce referential integrity in the database on these values
